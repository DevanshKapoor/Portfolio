...
const SkillComponent = ({ skill = "nan", info }) => {
  return (
    <div className="container h-[55vh] w-[40vw] border border-yellow-500 rounded-xl hover:bg-gray-900 overflow-auto scrollbar scrollbar-thumb-yellow-500 scrollbar-track-gray-900">
